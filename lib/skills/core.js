  ...
  async writeJson(filename, data) {
    ...
    try {
      ...
      if (e.code === 'ENOENT') {
        ...
        console.warn(`[Code-Graph] Warning: Failed to parse ${filename}; leaving existing file unchanged: ${e.message}`);
        return;
      }
    }
