...
export function thinkBeforeCodingSpec() {
  ...
  return {
    ...
    codexHookMessage: `MANDATORY(ThinkBeforeCoding): Before non-trivial work, state assumptions, ambiguity, tradeoffs, and simpler options. Ask when ambiguity changes implementation.`,
    opencodePlugin: `export default { name: 'thinkbeforecoding', beforeExecute: () => "MANDATORY: Before non-trivial work, state assumptions, ambiguity, tradeoffs, and simpler options. Ask when ambiguity changes implementation." };`,
    antigravitySkill: skillFile,
...
export function changeLimitSpec() {
  ...
  return {
    ...
    codexHookMessage: `MANDATORY(SurgicalChanges): Change ONLY what the task explicitly requires. Do not refactor, rename, or improve surrounding code.`,
    opencodePlugin: `export default { name: 'changelimit', beforeExecute: () => "MANDATORY: Surgical changes only. Change only what is explicitly required; no refactoring, style fixes, or improvements to untouched code." };`,
    antigravitySkill: skillFile,
...
export function goalDrivenSpec() {
  ...
  return {
    ...
    codexHookMessage: `MANDATORY(GoalDriven): Define success criteria and verification before implementation. For bugs, reproduce first. Report verification result or blocker.`,
    opencodePlugin: `export default { name: 'goaldriven', beforeExecute: () => "MANDATORY: Define success criteria and verification before implementation. For bugs, reproduce first. Report verification result or blocker." };`,
    antigravitySkill: skillFile,
