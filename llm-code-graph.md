...
- *test/index.test.js (11↑ 0↓) | d: Contains 1 symbols.
  - s: [doSomething [()]]
- lib/config.js (0↑ 11↓) | d: @file lib/config.js @description Constants, configuration, and shared utilities.
...
- lib/mapper.js (5↑ 1↓) | d: @file lib/mapper.js @description Manages the project mapping and file generation
